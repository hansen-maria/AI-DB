    ...
    <template v-else-if="job">
      ...
      <div class="tab-content">
        ...
        <SequencesTab
            ...
            :baktaWorkflowMode="bakta.baktaWorkflowMode.value"
            :baktaAutoIngestEnabled="bakta.autoIngestAnnotations.value"
            ...
            @update:baktaWorkflowMode="bakta.setBaktaWorkflowMode($event)"
            @update:baktaAutoIngestEnabled="bakta.setAutoIngestAnnotations($event)"
