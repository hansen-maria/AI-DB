  ...
  <div class="job-detail">
    ...
    <template v-else-if="job">
      ...
      <div v-if="job.status === 'completed'" class="tab-navigation">
        ...
        <button class="tab-btn" :class="{ active: activeTab === 'sequences' }" @click="activeTab = 'sequences'">Sequences</button>
        <button class="tab-btn" :class="{ active: activeTab === 'analysis'  }" @click="activeTab = 'analysis'">Functional Analysis</button>
      </div>
